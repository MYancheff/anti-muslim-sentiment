...
```{r, load data}
State_crime <- read_csv("/Users/emilyclark/Desktop/Junior/States/Crimes_state.csv") %>% mutate(Geo_Name = str_replace_all(Geo_Name, " ", "."))
ACS <-read_csv("/Users/emilyclark/Desktop/Junior/States/ACS_State.csv") %>% mutate(Geo_NAME = str_replace_all(Geo_NAME, " ", "."))
...
```{r}
write_csv(StateCensus, "StateCensus.csv")
